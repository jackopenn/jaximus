...
def get_config():
    cfg = Config()
    cfg.seed = 42
    cfg.exp_name = "nanochat100-canon"

    # Model type: "base" or "canon"
    cfg.model.type = "canon"
    ...
    # Canon layer settings
    cfg.model.canon_enabled = True
    cfg.model.canon_a = True   # After att_norm, before attention
    cfg.model.canon_b = True   # After Q/K/V projections
    cfg.model.canon_c = True   # After mlp_norm, before MLP
    cfg.model.canon_d = True   # After up_proj, before activation
    cfg.model.canon_init = "identity"  # "identity" | "ones" | "normal"
    ...
    # Canon weights use adamw (they're small 1D vectors)
    cfg.optimizer.canon.patterns = ["canon"]
    cfg.optimizer.canon.type = "adamw"
    cfg.optimizer.canon.peak_lr = 0.01
    ...
    cfg.checkpoint_dir = "gs://trm-jax-123/jaximus/checkpoints/nanochat100-canon"
    cfg.xpu = "v4"
    cfg.wandb = True
