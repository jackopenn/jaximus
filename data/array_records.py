...
from data.grain_transforms import ParseArrayRecord, Shift, Tokenize
...
def get_array_record_dataset(
    ...
    ds = grain.MapDataset.source(grain.sources.ArrayRecordDataSource(array_files)).map(ParseArrayRecord())
