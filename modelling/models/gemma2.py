...
class Gemma2(nnx.Module):
    def __init__(self, config: Gemma2Config, rngs: nnx.Rngs):
        ...
        self.layers = nnx.List([
            Gemma2Layer(
                ...
                sliding_window=config.sliding_window if (layer_idx + 1) % 2 == 0 else None,
    ...
    def __call__(self, input_ids: jnp.ndarray, mask: jnp.ndarray | None = None) -> jnp.ndarray:
        ...
        with jax.named_scope("attend"):
            logits = self.token_embedding.attend(x)
